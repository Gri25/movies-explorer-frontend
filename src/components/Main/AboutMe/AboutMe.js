    ...
    <section className="about-me">
      ...
      <div className="about-me__main">
        <div className="about-me__main-left">
          ...
          <h4 className="about-me__main-left-profession">
            Фронтенд-разработчик, 26 лет
          </h4>
          <p className="about-me__main-left-about">
            Я живу в Санкт-Петербурге, закончил химический факультет УГЛТУ. Я
            люблю слушать музыку, а ещё увлекаюсь бегом. Недавно начал кодить. С
            2022 года я безработный. Но до этого я работал руководителем на
            крупном частном производстве.
          </p>
          <nav>
            <a
              href="https://vk.com/feed"
              className="about-me__main-left-link"
              target="blank"
            >
              VKontakte
            </a>
            <a
              href="https://github.com/Gri25"
              className="about-me__main-left-link"
              target="blank"
            >
              Github
      ...
      <nav className="about-me__portfolio">
        ...
        <div className="about-me__portfolio-block">
          ...
          <a
            href="https://github.com/Gri25/how-to-learn"
            className="about-me__portfolio-block-link"
            target="blank"
          >
            ↗
          </a>
        ...
        <div className="about-me__portfolio-block">
          ...
          <a
            href="https://github.com/Gri25/russian-travel"
            className="about-me__portfolio-block-link"
            target="blank"
          >
            ↗
        ...
        <div className="about-me__portfolio-block">
          <p className="about-me__portfolio-block-text">
            Одностраничное приложение
          </p>
          <a
            href="https://github.com/Gri25/react-mesto-api-full"
            className="about-me__portfolio-block-link"
            target="blank"
          >
            ↗
